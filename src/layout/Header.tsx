...
export default function Header() {
  ...
  const submitForm = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.table(e.target[0].value);
  };
  ...
  return (
    <>
      ...
      <header className="py-4 px-16 relative bg-gray-700 grid place-items-center">
...
function SearchComponent({
  ...
  return (
    <form {...formProps}>
      <Label {...labelProps}>Find what you need: </Label>
...
function LinkComponent({
  ...
  return (
    <>
      ...
      {linkMenus.map((curr) => {
        return (
          <Button key={curr.to} {...buttonProps}>
            <Link
