...
export function CarouselPlugin() {
	...
	return (
		<section id="hero-carousel" className="grid place-items-center">
			<Carousel
				opts={{ loop: true }}
			...
			>
				...
				<CarouselPrevious
					variant={"default"}
					className="absolute top-1/2 left-4 bg-transparent>"
				/>
				<CarouselNext
					variant={"default"}
					className="absolute top-1/2 right-4 bg-transparent"
				/>
